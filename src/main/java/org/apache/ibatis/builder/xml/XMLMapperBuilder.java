...
public class XMLMapperBuilder extends BaseBuilder {
    ...
    // InputStream, Configuration, null, configuration.sqlFragments
    public XMLMapperBuilder(InputStream inputStream, Configuration configuration, String resource, Map<String, XNode> sqlFragments) { //构造器
    ...
    private void parameterMapElement(List<XNode> list) {
        for (XNode parameterMapNode : list) {
            ...
            Class<?> parameterClass = resolveClass(type); //转换为Class对象
